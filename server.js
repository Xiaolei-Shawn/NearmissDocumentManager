...
app.all('/mapi/resources/*', [require('./middlewares/validateRequest')]);
app.all('/mapi/users/*', [require('./middlewares/validateRequest')]);
...
app.use('/mapi', require('./controllers/mobile.controller'));
